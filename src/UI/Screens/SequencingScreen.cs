    ...
    public class SequencingScreen : ScreenBase
    {
        ...
        private void InitSequenceUI()
        {
            ...
            _nextAnimationGroupSkipJSON =
                new JSONStorableString("Exclude substrings (separate with comma)", string.Empty, val => current.nextAnimationSkipToken = val);
        ...
        private void UpdateValues()
        {
            ...
            _nextAnimationGroupSkipJSON.val = current.nextAnimationSkipToken;
